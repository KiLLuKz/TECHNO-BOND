...
// 📡 ดึงค่าโดยตรงจาก Vercel Environment Variables (ไม่มี VITE_)
const SUPABASE_URL = process.env.SUPABASE_URL || 'https://ndgkhfjxmtsukvbcwmzr.supabase.co';
const SUPABASE_KEY = process.env.SUPABASE_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im5kZ2toZmp4bXRzdWt2YmN3bXpyIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODEzMzc1OTksImV4cCI6MjA5NjkxMzU5OX0.ZhlGON-VTyj9HaPPwB97cHGn8znAs2Na-YDFIXZB3sI';
