          ...
          return clueData?.[clueField] ? (
            <div key={clueField} className="p-3 bg-[#d966ff]/10 border border-[#d966ff]/20 rounded-xl flex justify-between items-center">
              <div>
                  ...
                  <span className="text-gray-300 text-xs">{truncateText(clueData[clueField])}</span>
              </div>
            ...
            <div key={clueField} className="flex flex-col gap-2">
              ...
              <div className="flex gap-2">
                <input 
                    className="flex-1 bg-black/30 border border-white/10 rounded-lg p-2 text-xs text-white focus:outline-none focus:border-[#d966ff]/50" 
