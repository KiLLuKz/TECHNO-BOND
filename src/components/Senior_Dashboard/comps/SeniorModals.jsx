...
export const InboxModal = ({ isOpen, onClose, realMessages, getDefaultAvatar, formatTime }) => {
 ...
 <h3 className="font-['Orbitron'] text-[#7eb8ff] mb-6 font-bold tracking-widest uppercase flex items-center gap-3 text-xl">
 ...
 <span className="text-sm md:text-base text-[#7eb8ff] tracking-widest font-bold">{msg.display_name}</span>
 <span className="text-xs md:text-sm md:text-base text-gray-400 flex items-center gap-1.5">
...
export const ClueModal = ({ isOpen, content, onClose, notify }) => {
 ...
 <h3 className="font-['Orbitron'] text-[#d966ff] mb-4 font-bold tracking-widest uppercase">FULL_CLUE_DATA</h3>
 <p className="text-sm md:text-base text-gray-300 break-all mb-6 font-['Rajdhani'] leading-relaxed">{content}</p>
 <button className="w-full py-3 bg-[#d966ff]/20 border border-[#d966ff] rounded-lg text-sm md:text-base hover:bg-[#d966ff]/40 flex items-center justify-center gap-2 transition-all active:scale-95"
