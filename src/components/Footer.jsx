...
const Footer = () => {
 ...
 return (
 <footer className={`w-full relative z-50 mt-auto py-4 px-6 bg-[#08050f]/80 backdrop-blur-xl border-t ${borderColor} flex flex-col items-center justify-center transition-colors duration-700`}>
