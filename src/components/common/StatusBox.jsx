...
const StatusBox = ({ username, role, level = 12, exp = 450, maxExp = 1000, color ="#99eedd" }) => {
 ...
 <h3 className="font-['Orbitron'] text-white/50 tracking-widest font-bold text-[10px] absolute top-4 left-4">SYSTEM STATUS</h3>
 ...
 <span className="text-[10px] text-gray-400 font-bold tracking-widest leading-none mb-1">LV</span>
 ...
 <div 
 className="text-[9px] tracking-[0.2em] px-2 py-1 rounded border font-bold mb-2"
 style={{ 
 color: color, 
 ...
 <span className="text-[#f0eaff] text-sm md:text-base font-bold tracking-wider font-['Rajdhani'] truncate w-full text-center">
