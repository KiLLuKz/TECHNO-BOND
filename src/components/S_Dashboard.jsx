...
const S_Dashboard = ({ isAdmin }) => {
 ...
 <h1 className="font-['Orbitron'] text-2xl md:text-4xl text-[#d966ff] mb-6 md:mb-8 tracking-widest drop-shadow-[0_0_10px_rgba(217,102,255,0.5)] text-center md:text-left">
 SENIOR_CENTER
 </h1>
