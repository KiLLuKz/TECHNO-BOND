  ...
  return (
    <div className="lg:col-span-2 bg-[#08050f]/60 backdrop-blur-xl border border-white/10 rounded-[20px] p-6 shadow-xl flex flex-col">
      ...
      <div className="space-y-4 flex-1">
        {/* Clue #1 */}
        <div className="p-4 bg-[#99eedd]/10 border border-[#99eedd]/20 rounded-xl text-sm cursor-pointer hover:bg-[#99eedd]/20 transition-all" 
        ...
        {/* Clue #2 */}
        <div className={`p-4 border rounded-xl text-sm flex items-center justify-between transition-all ${isClue2Unlocked ? 'bg-[#99eedd]/10 border-[#99eedd]/20 cursor-pointer hover:bg-[#99eedd]/20' : 'bg-white/5 border-white/10 text-gray-500 cursor-not-allowed'}`} 
        ...
        {/* Clue #3 */}
        <div className={`p-4 border rounded-xl text-sm flex items-center justify-between transition-all ${isClue3Unlocked ? 'bg-[#99eedd]/10 border-[#99eedd]/20 cursor-pointer hover:bg-[#99eedd]/20' : 'bg-white/5 border-white/10 text-gray-500 cursor-not-allowed'}`} 
