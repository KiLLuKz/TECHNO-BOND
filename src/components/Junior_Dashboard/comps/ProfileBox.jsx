...
const ProfileBox = ({ profile, setProfile, handleUploadAvatar, handleUploadBanner, handleUpdateProfile, isSaving, defaultAvatar, userEmail, notify, exp }) => {
 ...
 <input 
 className="bg-black/40 border border-white/10 rounded-lg py-2.5 pl-9 pr-3 text-center text-sm md:text-base w-full text-[#99eedd] focus:outline-none focus:border-[#99eedd]/70 focus:bg-white/5 transition-all font-bold placeholder-gray-600 shadow-inner" 
 ...
 disabled={isSaving} 
 className="w-full py-2.5 mt-auto bg-white/5 border border-white/10 rounded-lg text-xs md:text-sm font-bold tracking-widest hover:bg-[#99eedd]/20 hover:text-[#99eedd] hover:border-[#99eedd]/50 flex items-center justify-center gap-2 transition-all active:scale-95"
 >
...
<div className="bg-[#08050f]/60 backdrop-blur-sm border border-white/10 rounded-[20px] p-6 flex flex-col items-center justify-center h-full min-h-[200px]">
 ...
 <h3 className="font-['Orbitron'] text-[#99eedd] tracking-widest font-bold text-xs md:text-sm md:text-base mb-1">ACCOUNT INFORMATION</h3>
 ...
 <span className="text-[#f0eaff] text-xs md:text-sm md:text-base font-mono">{profile.student_id || 'N/A'}</span>
 </div>
