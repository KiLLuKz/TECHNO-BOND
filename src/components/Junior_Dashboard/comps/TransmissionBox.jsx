...
const TransmissionBox = ({ 
 ...
 className="bg-[#08050f]/60 backdrop-blur-xl border border-white/10 rounded-[20px] p-6 flex flex-col h-full"
 >
 
 <h2 className="font-['Orbitron'] flex items-center gap-2 text-[#7eb8ff] mb-4 font-bold tracking-widest">
 <MessageSquare size={18} /> TRANSMISSION
 </h2>

 {/* เพิ่ม flex-1 เพื่อให้ textarea ยืดหยุ่นตามความสูงของกล่อง */}
 <textarea 
 className="flex-1 w-full min-h-[100px] bg-black/30 border border-white/10 rounded-xl p-3 text-sm md:text-base focus:outline-none mb-3 resize-none transition-all focus:border-[#7eb8ff]/50" 
 ...
 transition={isSending ? { repeat: Infinity, duration: 1 } : {}}
 className={`w-full py-2 rounded-lg text-xs md:text-sm md:text-base flex items-center justify-center gap-2 transition-all active:scale-95 
