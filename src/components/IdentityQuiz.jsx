...
const IdentityQuiz = ({ onCorrect }) => {
 ...
 <p className="text-[#99eedd] font-bold text-sm md:text-base tracking-widest mb-2">ACCESS GRANTED</p>
 ...
 className="mt-6 text-xs md:text-sm md:text-base text-red-500"
 >
 {errorMessage}
 </motion.p>
 )}
