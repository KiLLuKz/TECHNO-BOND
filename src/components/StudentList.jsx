...
const StudentList = () => {
 ...
 return (
 <div className="min-h-screen text-white pt-24 pb-12 px-2 md:px-6 selection:bg-[#7ecfff] selection:text-[#060412]">
 ...
 >
 <h1 className="font-['Orbitron'] text-4xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#7ecfff] to-[#d966ff] mb-4 drop-shadow-[0_0_15px_rgba(126,207,255,0.5)]">
 M.6/8 ROSTER
 </h1>
 <p className="text-[#99eedd] text-lg">ทำเนียบรุ่นนักเรียนชั้นมัธยมศึกษาปีที่ 6/8</p>
 </motion.div>
 ...
 className="w-full bg-[#08050f]/80 backdrop-blur-md border border-[#7ecfff]/50 rounded-full py-3 px-6 text-white placeholder-[#7ecfff]/40 focus:outline-none focus:border-[#d966ff] focus:shadow-[0_0_15px_rgba(217,102,255,0.4)] transition-all"
 />
 ...
 {/* Number Badge */}
 <div className="absolute top-3 left-3 bg-black/60 backdrop-blur-md border border-[#99eedd]/50 text-[#99eedd] text-xs md:text-sm md:text-base font-bold px-2 py-1 rounded shadow-[0_0_10px_rgba(153,238,221,0.3)] z-10">
 No. {student.senior_id}
 </div>

 {/* Student Info (Positioned at bottom) */}
 <div className="absolute bottom-0 left-0 w-full p-4 md:p-5 flex flex-col justify-end z-10">
 <h3 className="font-['Orbitron'] text-xl md:text-2xl font-bold text-white mb-1 truncate drop-shadow-md">
 {student.senior_nickname || student.username || 'Unknown'}
 </h3>
 <p className="text-xs md:text-sm md:text-base text-gray-300 truncate drop-shadow-md">
 {student.senior_full_name || 'No Name Provided'}
 </p>
 
 {/* Future Feature Placeholder */}
 <div className="mt-3 text-[10px] md:text-xs md:text-sm md:text-base bg-[#4f2ec3]/40 border border-[#4f2ec3]/50 text-[#e0b3ff] rounded px-2 py-1 backdrop-blur-sm self-start uppercase tracking-wider">
 [ Univ. Status: TBD ]
 </div>
 </div>
 </motion.div>
