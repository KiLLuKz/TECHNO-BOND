...
export default function HomeworkHub({ userRole, isAdmin, readOnly = false }) {
 ...
 <label className="text-sm md:text-base text-[#99eedd] tracking-widest">SUBJECT</label>
 ...
 <div className="space-y-1">
 <label className="text-sm md:text-base text-[#99eedd] tracking-widest">DUE DATE (Ex.01/07/2026)</label>
 <div className="relative group">
 ...
 <label className="text-sm md:text-base text-[#99eedd] tracking-widest">DESCRIPTION</label>
 ...
 <div className="space-y-1">
 <label className="text-sm md:text-base text-[#99eedd] tracking-widest">NOTES (OPTIONAL)</label>
 <div className="relative group">
 ...
 <div className="space-y-1">
 <label className="text-sm md:text-base text-[#99eedd] tracking-widest">ATTACHMENT (IMAGE)</label>
 ...
 <input type="file" accept="image/*" onChange={handleFileChange} className="w-full text-sm md:text-base text-[#f0eaff] file:mr-4 file:py-1 file:px-3 file:rounded-md file:border-0 file:text-xs md:text-sm md:text-base file:font-semibold file:bg-[#d966ff]/20 file:text-[#ff7ec8] hover:file:bg-[#d966ff]/40 transition-colors" />
 </div>
 </div>
 ...
 className="w-full flex items-center justify-center gap-3 bg-[#d966ff]/20 hover:bg-[#d966ff]/40 border border-[#d966ff] disabled:opacity-50 text-[#f0eaff] font-bold tracking-widest py-4 rounded-xl transition duration-300 shadow-[0_0_15px_rgba(217,102,255,0.3)]">
 ...
 <button onClick={fetchHomework} className="bg-white/5 border border-white/10 hover:bg-white/10 px-4 py-2 rounded-lg text-sm md:text-base transition tracking-wider">
 REFRESH
 </button>
 </div>
 ...
 <div className="bg-white/5 border border-white/10 p-10 rounded-2xl text-center text-gray-500 tracking-widest">
 NO PENDING TASKS
 </div>
 ) : (
 ...
 <span className="bg-[#d966ff]/20 border border-[#d966ff]/50 text-[#ff7ec8] text-xs md:text-sm md:text-base uppercase tracking-widest font-bold px-3 py-1 rounded-md shadow-[0_0_10px_rgba(217,102,255,0.3)]">
 {hw.subject}
 </span>
 <span className="text-[#99eedd] text-xs md:text-sm md:text-base tracking-wider">DUE: {hw.due_date}</span>
 </div>
 <h3 className="font-['Orbitron'] text-lg font-semibold mb-2 text-[#f0eaff]">{hw.description}</h3>
 {hw.note && <p className="text-sm md:text-base text-gray-400 flex items-center gap-2"><FileText size={14} className="text-[#d966ff]"/> {hw.note}</p>}
 </div>
 ...
 <span className="text-xs md:text-sm md:text-base font-bold text-white tracking-widest bg-black/50 px-2 py-1 rounded-md">EXPAND</span>
 </div>
 </div>
 )}
