  ...
  return (
    ...
    <div className="min-h-screen text-white font-['Inter',sans-serif] overflow-x-hidden pt-20 pb-24">
      ...
      <section className="relative flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
        ...
        <div className="absolute top-1/2 left-0 right-0 w-full -translate-y-1/2 flex justify-center items-center text-[18vw] font-black text-white/5 font-['Orbitron'] uppercase select-none pointer-events-none tracking-widest z-0">
          FUTURE
        </div>
      ...
      <section className="max-w-6xl mx-auto mt-24 p-6 md:p-12 bg-[radial-gradient(circle_at_center,#4f2ec3_0%,transparent_100%)] border border-white/5 rounded-[40px]" data-aos="fade-up">
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-10">
          <button 
            ...
            className={`flex items-center gap-2 px-6 py-3 rounded-full font-['Orbitron'] text-xs md:text-sm tracking-wider transition-all duration-300 ${activeTab === 'dev' ? 'bg-[#a855f7] text-white shadow-[0_0_20px_rgba(168,85,247,0.5)] border-transparent scale-105' : 'bg-white/5 text-gray-400 border border-white/10 hover:bg-white/10 hover:text-white'}`}
          >
            <Terminal size={18} /> FULL-STACK DEV
          </button>
          <button 
            onClick={() => setActiveTab('art')}
            className={`flex items-center gap-2 px-6 py-3 rounded-full font-['Orbitron'] text-xs md:text-sm tracking-wider transition-all duration-300 ${activeTab === 'art' ? 'bg-[#a855f7] text-white shadow-[0_0_20px_rgba(168,85,247,0.5)] border-transparent scale-105' : 'bg-white/5 text-gray-400 border border-white/10 hover:bg-white/10 hover:text-white'}`}
          >
            <Palette size={18} /> DIGITAL ART
          </button>
          <button 
            onClick={() => setActiveTab('stem')}
            className={`flex items-center gap-2 px-6 py-3 rounded-full font-['Orbitron'] text-xs md:text-sm tracking-wider transition-all duration-300 ${activeTab === 'stem' ? 'bg-[#a855f7] text-white shadow-[0_0_20px_rgba(168,85,247,0.5)] border-transparent scale-105' : 'bg-white/5 text-gray-400 border border-white/10 hover:bg-white/10 hover:text-white'}`}
          >
            ...
            <>
              ...
              >
                ...
                <div className="flex flex-wrap gap-3">
                  <span className="px-4 py-2 bg-[#a855f7]/10 border border-[#a855f7]/50 rounded-lg text-xs md:text-sm text-[#c084fc] hover:bg-[#a855f7]/30 transition-colors cursor-default">C# / Game Dev</span>
          ...
          {activeTab === 'art' && (
            <>
              ...
              >
                ...
                <div className="flex flex-wrap gap-3">
                  <span className="px-4 py-2 bg-[#a855f7]/10 border border-[#a855f7]/50 rounded-lg text-xs md:text-sm text-[#c084fc] hover:bg-[#a855f7]/30 transition-colors cursor-default">UX/UI Design</span>
          ...
          {activeTab === 'stem' && (
            <>
              ...
              >
                ...
                <div className="flex flex-wrap gap-3">
                  <span className="px-4 py-2 bg-[#a855f7]/10 border border-[#a855f7]/50 rounded-lg text-xs md:text-sm text-[#c084fc] hover:bg-[#a855f7]/30 transition-colors cursor-default">Applied Physics</span>
