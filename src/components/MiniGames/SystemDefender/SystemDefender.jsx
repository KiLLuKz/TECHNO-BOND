...
export default function SystemDefender() {
 ...
 return (
 <div className="fixed inset-0 text-white overflow-hidden bg-black/40 backdrop-blur-sm z-50 cursor-crosshair"
 ...
 <h1 className="font-['Orbitron'] text-xl md:text-3xl font-bold text-[#ff3366] tracking-widest drop-shadow-[0_0_10px_rgba(255,51,102,0.8)]">
 SYSTEM DEFENDER
 <span className="text-[10px] md:text-xs md:text-sm md:text-base bg-[#ffe066] text-black px-2 py-0.5 rounded-full ml-2 align-middle shadow-[0_0_5px_#ffe066]">PRE-ALPHA</span>
 </h1>
 </div>
 )}
 ...
 className={`text-xs md:text-sm md:text-base px-3 py-2 rounded-xl font-bold transition-all backdrop-blur-md border ${isAutoLockOn ? 'bg-[#4ECDC4]/20 border-[#4ECDC4] text-[#4ECDC4]' : 'bg-white/10 border-white/30 text-gray-400 hover:bg-white/20'}`}
 >
 ...
 <h2 className="font-['Orbitron'] text-3xl font-bold mb-2 text-white">PROTECT THE CORE</h2>
 ...
 <div className="mt-6 text-sm md:text-base text-gray-400 font-bold">HIGH SCORE: <span className="text-[#4ECDC4]">{highScore}</span></div>
 </div>
 )}
 ...
 <h2 className="font-['Orbitron'] text-3xl md:text-5xl font-bold mb-4 text-white drop-shadow-[0_0_15px_rgba(255,0,0,0.8)]">CORE BREACHED</h2>
