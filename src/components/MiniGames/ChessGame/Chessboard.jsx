...
export default function Chessboard({ playMove, pieces }) {
  ...
  function grabPiece(e) {
    ...
    if (element.classList.contains("chess-piece") && chessboard) {
      ...
      element.style.zIndex = "100"; // ให้หมากลอยอยู่บนสุดตอนลาก
  ...
  function dropPiece(e) {
    ...
    if (activePiece && chessboard) {
      ...
      if (currentPiece) {
        ...
        if (!success) {
          // ถ้าวางไม่ได้ ให้เด้งกลับไปที่เดิม
  ...
  return (
    <div
      ...
      id="chessboard"
      ref={chessboardRef}
      className="grid grid-cols-8 grid-rows-8 w-[800px] h-[800px] bg-blue-900 border-8 border-[#2c2c2c] rounded-lg shadow-[0_0_50px_rgba(0,0,0,0.8)] relative isolate"
    >
      {board}
    </div>
  );
