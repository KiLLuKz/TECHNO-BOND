...
export default function BattleshipGame() {
 ...
 if (user) {
 const expAmount = gameMode === 'pve' ? 20 : 40;
 ...
 <h1 className="font-['Orbitron'] text-4xl font-bold mb-10 tracking-widest text-transparent bg-clip-text bg-gradient-to-r from-[#4ECDC4] to-[#2EC4B6]">BATTLESHIP</h1>
 ...
 const board = currentPlayer === 1 ? p1Board : p2Board;
 return (
 <div className="min-h-screen w-full flex flex-col items-center justify-center p-4 md:p-10 relative">
 ...
 <h1 className="font-['Orbitron'] text-xl md:text-2xl font-bold text-[#4ECDC4]">FLEET setup</h1>
 ...
 <p className="text-xs md:text-sm md:text-base text-gray-400">Click on the grid to deploy the ship.</p>
 <p className="text-sm md:text-base text-[#FFD166]">{unplacedShips[0].name} (Size: {unplacedShips[0].size})</p>
 <div className="flex flex-col gap-2 w-full">
 <button onClick={() => setIsHorizontal(!isHorizontal)} className="w-full bg-white/10 px-4 py-2 rounded-lg text-xs md:text-sm md:text-base hover:bg-white/20 transition-all font-bold flex items-center justify-center gap-2">
 <RotateCcw size={16}/> ROTATE (Press 'R')
 </button>
 <button onClick={() => { currentPlayer === 1 ? randomizeFleet(setP1Board, setP1Ships) : randomizeFleet(setP2Board, setP2Ships); setUnplacedShips([]); }} className="w-full bg-white/10 px-4 py-2 rounded-lg text-xs md:text-sm md:text-base hover:bg-white/20 transition-all font-bold flex items-center justify-center gap-2"><Shuffle size={16}/> RANDOM FLEET</button>
 </div>
 </div>
 ) : (
 <div className='flex flex-col gap-4 text-center items-center'>
 <Crown className='text-[#4ECDC4]' size={48}/>
 <p className="text-sm md:text-base font-bold text-[#4ECDC4]">Fleet ready for battle!</p>
 <button onClick={handleSetupDone} className="w-full bg-[#4ECDC4] text-black py-3 rounded-lg font-bold tracking-widest hover:scale-[1.02] transition-transform text-sm md:text-base">CONFIRM FLEET</button>
 </div>
 )}
 </div>
 </div>
 ...
 // --- Playing Screen ---
 return (
 <div className="min-h-screen w-full flex flex-col items-center justify-center text-white p-4 relative">
 {screen === 'gameover' && (
 ...
 <h2 className="font-['Orbitron'] text-5xl font-bold text-[#4ECDC4] mb-2">PLAYER {winner} WINS!</h2>
 <p className="text-xl font-bold text-[#ffe066] drop-shadow-[0_0_10px_rgba(255,224,102,0.8)] mb-10 animate-pulse">
 +{gameMode === 'pve' ? 20 : 40} EXP
 </p>
 ...
 <div className={`px-4 py-2 rounded-full font-bold tracking-widest text-xs md:text-sm md:text-base border text-center ${currentPlayer === 1 ? 'bg-[#FF6B6B]/20 border-[#FF6B6B]/50 text-[#FF6B6B]' : 'bg-[#FFD166]/20 border-[#FFD166]/50 text-[#FFD166]'}`}>
 ...
 <div className="text-center text-[#4ECDC4] mb-6 h-6 font-bold tracking-widest uppercase text-xs md:text-sm md:text-base">{log}</div>
 ...
 <h2 className="font-['Orbitron'] mb-4 font-bold tracking-widest text-sm md:text-base text-gray-300 flex items-center gap-2"><Crosshair size={18}/> P2 RADAR</h2>
 ...
 <div className='text-center tracking-widest text-xs md:text-sm md:text-base text-gray-300'>Attack the P1 Fleet below/right!</div>
 </div>
 )}
 </div>
 ...
 <h2 className="font-['Orbitron'] mb-4 font-bold tracking-widest text-sm md:text-base text-gray-300 flex items-center gap-2"><Droplets size={18}/> P1 FLEET</h2>
 ...
 <div className='text-center tracking-widest text-xs md:text-sm md:text-base text-gray-300'>Click the P2 Radar above/left to attack.</div>
 </div>
 )}
 </div>
