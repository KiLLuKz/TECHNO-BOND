...
const ShootEmUp = () => {
 ...
 return (
 <div ref={containerRef} className="relative w-full h-[100dvh] bg-[#060412] select-none overflow-hidden flex justify-center">
 ...
 >
 <h2 className="font-['Orbitron'] text-4xl md:text-6xl font-black text-[#ffe066] drop-shadow-[0_0_20px_rgba(255,224,102,0.8)] tracking-widest italic uppercase">
 LEVEL UP!
 </h2>
 ...
 <span className="text-[10px] md:text-xs md:text-sm md:text-base text-[#7ecfff] tracking-widest uppercase">Score</span>
 ...
 <div className="flex flex-col items-end">
 <span className="text-[10px] md:text-xs md:text-sm md:text-base text-[#d966ff] tracking-widest uppercase flex items-center gap-1">
 <Star size={12}/> Level
 </span>
 ...
 {healTextUI && (
 <span className="text-[#FF1493] text-[10px] md:text-xs md:text-sm md:text-base font-bold flex items-center gap-1 animate-[bounce_0.5s_infinite] drop-shadow-[0_0_8px_#FF1493]">
 <Heart size={12}/> +50 HP
 </span>
 )}
 {buffTimeUI > 0 && (
 <span className="text-[#3CFF00] text-[10px] md:text-xs md:text-sm md:text-base font-bold flex items-center gap-1 animate-pulse drop-shadow-[0_0_8px_#3CFF00]">
 <Zap size={12}/> SPEED: {buffTimeUI}s
 </span>
 )}
 {shieldActiveUI && (
 <span className="text-[#4ECDC4] text-[10px] md:text-xs md:text-sm md:text-base font-bold flex items-center gap-1 animate-pulse drop-shadow-[0_0_8px_#4ECDC4]">
 ...
 <span className="text-gray-300 text-[10px] md:text-xs md:text-sm md:text-base font-bold w-8 drop-shadow-md">HP</span>
 ...
 <span className="text-[10px] md:text-xs md:text-sm md:text-base font-bold w-8 text-right drop-shadow-md" style={{ color: hpColor }}>{hp}%</span>
 </div>

 {/* EXP Bar */}
 <div className="flex items-center gap-3 px-2">
 <span className="text-[#ffe066] text-[10px] md:text-xs md:text-sm md:text-base font-bold w-8 drop-shadow-md">EXP</span>
 ...
 <span className="text-[10px] md:text-xs md:text-sm md:text-base font-bold w-8 text-right text-[#ffe066] drop-shadow-md">
 ...
 <h1 className="font-['Orbitron'] text-3xl md:text-4xl font-bold text-[#7ecfff] tracking-[0.2em] mb-4 text-center">STARFIGHTER</h1>
 <div className="text-gray-300 text-sm md:text-base tracking-wider text-center leading-loose mb-10 font-['Rajdhani'] bg-black/40 px-6 py-4 rounded-xl border border-white/10 pointer-events-auto">
 ...
 <h1 className="font-['Orbitron'] text-4xl font-bold text-red-500 tracking-[0.2em] mb-8 drop-shadow-[0_0_15px_rgba(239,68,68,0.5)]">GAME OVER</h1>
 ...
 <p className="text-gray-400 text-sm md:text-base tracking-widest uppercase mb-2">Final Score</p>
 <p className="text-5xl font-bold text-[#ffe066] drop-shadow-[0_0_20px_rgba(255,224,102,0.6)] mb-2">{score.toLocaleString()}</p>
 <p className="text-[#d966ff] text-sm md:text-base tracking-wider font-bold mb-2">Weapon Level: {level >= 5 ? 'MAX' : level}</p>
 <p className="text-gray-500 text-sm md:text-base tracking-wider">Reached Wave {wave}</p>
 <p className="text-xl font-bold text-[#99eedd] drop-shadow-[0_0_10px_rgba(153,238,221,0.8)] mt-4 animate-pulse">
 +{earnedExp} EXP
 </p>
 </div>
