...
import { Menu, X, Home, LayoutDashboard, KeyRound, LogOut, Gamepad2, ShieldAlert, NotebookTabs, Users, Sparkles } from 'lucide-react';
...
const FloatingMenu = ({ userRole, isAdmin, onLogout }) => {
 ...
 <Link to="/activities" onClick={() => setIsOpen(false)} className="flex items-center gap-3 px-4 py-3 text-sm text-[#f0eaff] hover:bg-[#b464ff]/20 rounded-xl transition-all">
